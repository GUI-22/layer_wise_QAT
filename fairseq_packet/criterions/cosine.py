...
@dataclass
class CosineCriterionConfig(FairseqDataclass):
    sentence_avg: bool = II("optimization.sentence_avg")


@register_criterion("cosine", dataclass=CosineCriterionConfig)
class CosineCriterion(FairseqCriterion):
    ...
    def compute_loss(self, model, net_output, sample, reduce=True):
        ...
        ones = torch.ones(target.size(0)).to(target.device)
