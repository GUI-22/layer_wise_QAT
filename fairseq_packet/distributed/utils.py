...
def distributed_main(i, main, cfg: FairseqConfig, model=None, tokenizer=None, kwargs=None):
    ...
    main(cfg, model, tokenizer, **kwargs)

    if torch.distributed.is_initialized():
        torch.distributed.barrier(get_global_group())


def call_main(cfg: FairseqConfig, main, model=None, tokenizer=None, **kwargs):
    ...
    if cfg.distributed_training.distributed_init_method is not None:
        ...
        if not cfg.distributed_training.distributed_no_spawn:
            ...
            torch.multiprocessing.spawn(
                fn=distributed_main,
                args=(main, cfg, model, tokenizer, kwargs),
                nprocs=min(
            ...
            distributed_main(cfg.distributed_training.device_id, main, cfg, model, tokenizer, kwargs)
