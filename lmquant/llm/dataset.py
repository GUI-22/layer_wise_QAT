...
class LlmCalibrationCache(CalibrationCache):
    ...
    def get_layer_activations(  # noqa: C901
        self,
        ...
        layer_cache = self._get_layer_activations(
    ...
    @torch.inference_mode()
    def get_layer_args_kwargs_for_final_quant(  # noqa: C901
        self,
        model: nn.Module | LlmModelStruct,
        layer_idx: int,
        *args,
        ...
        **kwargs,
        ...
        layer_args_cache, layer_kwargs_cache = self._get_layer_args_kwargs_for_final_quant(
            model,
            layer_idx,
            *args,
            action=action,
