...
# @register_model_architecture("yoco", "yoco_base")
# def yoco_base(args):
#     args.dim = getattr(args, "dim", 3072)
#     args.hidden_dim = getattr(args, "hidden_dim", 8192)
#     args.n_layers = getattr(args, "n_layers", 26)
...
@register_model_architecture("yoco", "yoco_base")
def yoco_base(args):
    args.dim = getattr(args, "dim", 1536)
    args.hidden_dim = getattr(args, "hidden_dim", 4096)
    args.n_layers = getattr(args, "n_layers", 26)
    args.n_self_heads = getattr(args, "n_self_heads", 12)
    args.n_attn_heads = getattr(args, "n_attn_heads", 12)
    args.n_attn_kv_heads = getattr(args, "n_attn_kv_heads", 4)
    default(args)
